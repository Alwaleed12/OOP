public class App {
    public static void main(String[] args) throws Exception {
        ...
        Student student = new Student("Alwaleed", "Algheraibi", "CHC");
        System.out.println(student.greeting());

        // Write the lines of code to create an udergradStudent object.
        ...
        // Strongly typed programming languages will attempt to determine the type for
        // you
